...
(() => {
    ...
    var i,
        ...
        ge = function () {
            var e,
                ...
                i = te.length,
                n = te.slice(0);
            for (ie = {}, te.length = 0, e = 0; e < i; e++) (t = n[e]) && t._lazy && (t.render(t._lazy[0], t._lazy[1], !0)._lazy = 0);
        },
        ve = function (e, t, i, r) {
            te.length && !n && ge(), e.render(t, i, r || (n && t < 0 && (e._initted || e._startAt))), te.length && !n && ge();
        },
        _e = function (e) {
            var t = parseFloat(e);
        ...
        Te = function e(t, i) {
            for (var n in i) '__proto__' !== n && 'constructor' !== n && 'prototype' !== n && (t[n] = A(i[n]) ? e(t[n] || (t[n] = {}), i[n]) : i[n]);
            return t;
        },
        xe = function (e, t) {
            var i,
        ...
        Oe = function (e, t, i, r) {
            return e._startAt && (n ? e._startAt.revert(Z) : (e.vars.immediateRender && !e.vars.autoRevert) || e._startAt.render(t, !0, r));
        },
        Pe = function e(t) {
        ...
        ze = function (e, t) {
            var i = e._dp;
            return i && i.smoothChildTiming && e._ts && ((e._start = he(i._time - (e._ts > 0 ? t / e._ts : ((e._dirty ? e.totalDuration() : e._tDur) - t) / -e._ts))), De(e), i._dirty || ke(i, e)), e;
        },
        Ie = function (e, t) {
            var i;
            if (((t._time || (t._initted && !t._dur)) && ((i = $e(e.rawTime(), t)), (!t._dur || We(0, t.totalDuration(), i) - t._tTime > w) && t.render(i, !0)), ke(e, t)._dp && e._initted && e._time >= e._dur && e._ts)) {
                if (e._dur < e.duration()) for (i = e; i._dp; ) i.rawTime() >= 0 && i.totalTime(i._tTime), (i = i._dp);
                e._zTime = -1e-8;
            }
        },
        Be = function (e, t, i, n) {
            return t.parent && Me(t), (t._start = he((O(i) ? i : i || e !== s ? Ve(e, i, t) : e._time) + t._delay)), (t._end = he(t._start + (t.totalDuration() / Math.abs(t.timeScale()) || 0))), Se(e, t, '_first', '_last', e._sort ? '_start' : 0), Ge(t) || (e._recent = t), n || Ie(e, t), e._ts < 0 && ze(e, e._tTime), e;
        },
        Fe = function (e, t) {
            return (H.ScrollTrigger || X('scrollTrigger', t)) && H.ScrollTrigger.create(t, e);
        },
        Re = function (e, t, i, r, s) {
            return jt(e, t, s), e._initted ? (!i && e._pt && !n && ((e._dur && !1 !== e.vars.lazy) || (!e._dur && e.vars.lazy)) && u !== Tt.frame ? (te.push(e), (e._lazy = [s, r]), 1) : void 0) : 1;
        },
        Ne = function e(t) {
            var i = t.parent;
        ...
        qe = function (e, t, i, n) {
            var r = e._repeat,
                s = he(t) || 0,
                a = e._tTime / e._tDur;
            return a && !n && (e._time *= s / e._dur), (e._dur = s), (e._tDur = r ? (r < 0 ? 1e10 : he(s * (r + 1) + e._rDelay * r)) : s), a > 0 && !n && ze(e, (e._tTime = e._tDur * a)), e.parent && De(e), i || ke(e.parent, e), e;
        },
        je = function (e) {
        ...
        Ve = function e(t, i, n) {
            ...
            return M(i) && (isNaN(i) || i in o)
                ? ((s = i.charAt(0)),
                  ...
                  (r = i.indexOf('=')),
                  '<' === s || '>' === s
                      ? (r >= 0 && (i = i.replace(/=/, '')), ('<' === s ? l._start : l.endTime(l._repeat >= 0)) + (parseFloat(i.substr(1)) || 0) * (a ? (r < 0 ? l : n).totalDuration() / 100 : 1))
                      : r < 0
                      ? (i in o || (o[i] = d), o[i])
                      : ((s = parseFloat(i.charAt(r - 1) + i.substr(r + 1))), a && n && (s = (s / 100) * (I(n) ? n[0] : n).totalDuration()), r > 1 ? e(t, i.substr(0, r - 1), n) + s : d + s))
                : null == i
                ? d
                : +i;
        },
        ...
        Ke = [].slice,
        Qe = function (e, t) {
            return e && A(e) && 'length' in e && ((!t && !e.length) || (e.length - 1 in e && A(e[0]))) && !e.nodeType && e !== a;
        },
        Ze = function (e, t, i) {
            ...
            return (
                ...
                function (e, a, c) {
                    ...
                    if (!x) {
                        ...
                        for (x = s[T] = [], p = o ? Math.min(b, T) * d - 0.5 : n % b, h = b === y ? 0 : o ? (T * u) / b - 0.5 : (n / b) | 0, _ = 0, w = y, v = 0; v < T; v++) (f = (v % b) - p), (m = h - ((v / b) | 0)), (x[v] = g = l ? Math.abs('y' === l ? m : f) : C(f * f + m * m)), g > _ && (_ = g), g < w && (w = g);
                        'random' === n && et(x), (x.max = _ - w), (x.min = w), (x.v = T = (parseFloat(t.amount) || parseFloat(t.each) * (b > T ? T - 1 : l ? ('y' === l ? T / b : b) : Math.max(b, T / b)) || 0) * ('edges' === n ? -1 : 1)), (x.b = T < 0 ? r - T : r), (x.u = Ue(t.amount || t.each) || 0), (i = i && T < 0 ? kt(i) : i);
                    }
        ...
        nt = function (e, t) {
            var i,
                ...
                r = I(e);
            return (
                !r && A(e) && ((i = r = e.radius || y), e.values ? ((e = Ze(e.values)), (n = !O(e[0])) && (i *= i)) : (e = it(e.increment))),
                Xe(
                    t,
                    r
                        ? k(e)
                            ...
                            : function (t) {
                                  for (var r, s, a = parseFloat(n ? t.x : t), o = parseFloat(n ? t.y : 0), l = y, d = 0, u = e.length; u--; ) (r = n ? (r = e[u].x - a) * r + (s = e[u].y - o) * s : Math.abs(e[u] - a)) < l && ((l = r), (d = u));
        ...
        rt = function (e, t, i, n) {
            return Xe(I(e) ? !t : !0 === i ? !!(i = 0) : !n, function () {
                return I(e) ? e[~~(Math.random() * e.length)] : (i = i || 1e-5) && (n = i < 1 ? Math.pow(10, (i + '').length - 2) : 1) && Math.floor(Math.round((e - i / 2 + Math.random() * (t - e + 0.99 * i)) / i) * i * n) / n;
            });
        },
        st = function (e, t, i) {
        ...
        at = function (e) {
            for (var t, i, n, r, s = 0, a = ''; ~(t = e.indexOf('random(', s)); ) (n = e.indexOf(')', t)), (r = '[' === e.charAt(t + 7)), (i = e.substr(t + 7, n - t - 7).match(r ? q : B)), (a += e.substr(s, t - s) + rt(r ? i : +i[0], r ? 0 : +i[1], +i[2] || 1e-5)), (s = n + 1);
        ...
        dt = function (e, t, i) {
            var n,
                ...
                d = r,
                u = e._ctx;
            if (l) return (n = o[t + 'Params']), (s = o.callbackScope || e), i && te.length && ge(), u && (r = u), (a = n ? l.apply(s, n) : l.call(s)), (r = d), a;
        },
        ut = function (e) {
        ...
        pt = function (e) {
            if ($()) {
                ...
                if ((xt(), e !== n)) {
                    if (ne[t]) return;
                    we(n, we(xe(e, r), s)), be(n.prototype, be(r, xe(e, s))), (ne[(n.prop = t)] = n), e.targetTest && (ae.push(n), (ee[t] = 1)), (t = ('css' === t ? 'CSS' : t.charAt(0).toUpperCase() + t.substr(1)) + 'Plugin');
                }
        ...
        mt = function (e, t, i) {
            return ((6 * (e += e < 0 ? 1 : e > 1 ? -1 : 0) < 1 ? t + (i - t) * e * 6 : e < 0.5 ? i : 3 * e < 2 ? t + (i - t) * (2 / 3 - e) * 6 : t) * ht + 0.5) | 0;
        },
        gt = function (e, t, i) {
            var n,
                r,
            ...
            if (!h) {
                if ((',' === e.substr(-1) && (e = e.substr(0, e.length - 1)), ft[e])) h = ft[e];
                    ...
                    if ((e.length < 6 && ((n = e.charAt(1)), (r = e.charAt(2)), (s = e.charAt(3)), (e = '#' + n + n + r + r + s + s + (5 === e.length ? e.charAt(4) + e.charAt(4) : ''))), 9 === e.length)) return [(h = parseInt(e.substr(1, 6), 16)) >> 16, (h >> 8) & ht, h & ht, parseInt(e.substr(7), 16) / 255];
                    h = [(e = parseInt(e.substr(1), 16)) >> 16, (e >> 8) & ht, e & ht];
                } else if ('hsl' === e.substr(0, 3))
                    if (((h = p = e.match(B)), t)) {
                        if (~e.indexOf('=')) return (h = e.match(F)), i && h.length < 4 && (h[3] = 1), h;
                    } else (a = (+h[0] % 360) / 360), (o = +h[1] / 100), (n = 2 * (l = +h[2] / 100) - (r = l <= 0.5 ? l * (o + 1) : l + o - l * o)), h.length > 3 && (h[3] *= 1), (h[0] = mt(a + 1 / 3, n, r)), (h[1] = mt(a, n, r)), (h[2] = mt(a - 1 / 3, n, r));
            ...
            return (
                t &&
                    ...
                    d === u ? (a = o = 0) : ((c = d - u), (o = l > 0.5 ? c / (2 - d - u) : c / (d + u)), (a = d === n ? (r - s) / c + (r < s ? 6 : 0) : d === r ? (s - n) / c + 2 : (n - r) / c + 4), (a *= 60)),
                    (h[0] = ~~(a + 0.5)),
                    (h[1] = ~~(100 * o + 0.5)),
                    (h[2] = ~~(100 * l + 0.5))),
                i && h.length < 4 && (h[3] = 1),
        ...
        _t = function (e, t, i) {
            ...
            if (
                ((l = l.map(function (e) {
                    return (e = gt(e, t, 1)) && d + (t ? e[0] + ',' + e[1] + '%,' + e[2] + '%,' + e[3] : e.join(',')) + ')';
                })),
                i && ((s = vt(e)), (n = i.c).join(o) !== s.c.join(o)))
            )
                for (a = (r = e.replace(yt, '1').split(R)).length - 1; u < a; u++) o += r[u] + (~n.indexOf(u) ? l.shift() || d + '0,0,0,0)' : (s.length ? s : l.length ? l : i).shift());
        ...
        bt = function (e) {
            var t,
                i = e.join(' ');
            if (((yt.lastIndex = 0), yt.test(i))) return (t = wt.test(i)), (e[1] = _t(e[1], t)), (e[0] = _t(e[0], t, vt(e[1]))), !0;
        },
        Tt = (function () {
            var e,
                t,
                ...
                y = function i(a) {
                    var o,
                        ...
                        y = u() - m,
                        w = !0 === a;
                    if ((y > c && (f += y - h), ((o = (d = (m += y) - f) - v) > 0 || w) && ((p = ++n.frame), (r = d - 1e3 * n.time), (n.time = d /= 1e3), (v += o + (o >= g ? 4 : g - o)), (l = 1)), w || (e = t(i)), l)) for (s = 0; s < _.length; s++) _[s](d, r, p, a);
                };
            return (n = {
                time: 0,
                frame: 0,
                ...
                wake: function () {
                    d &&
                        (!o && $() && ((a = o = window), (l = a.document || {}), (H.gsap = wi), (a.gsapVersions || (a.gsapVersions = [])).push(wi.version), Y(V || a.GreenSockGlobals || (!a.gsap && a) || {}), (i = a.requestAnimationFrame), ct.forEach(pt)),
                        e && n.sleep(),
                        (t =
                            i ||
                            function (e) {
        ...
        Et = /["']/g,
        Mt = function (e) {
            for (var t, i, n, r = {}, s = e.substr(1, e.length - 3).split(':'), a = s[0], o = 1, l = s.length; o < l; o++) (i = s[o]), (t = o !== l - 1 ? i.lastIndexOf(',') : i.length), (n = i.substr(0, t)), (r[a] = isNaN(n) ? n.replace(Et, '').trim() : +n), (a = i.substr(t + 1).trim());
            return r;
        },
        kt = function (e) {
            return function (t) {
        ...
        Ot = function e(t, i) {
            for (var n, r = t._first; r; ) r instanceof Bt ? e(r, i) : !r.vars.yoyoEase || (r._yoyo && r._repeat) || r._yoyo === i || (r.timeline ? e(r.timeline, i) : ((n = r._ease), (r._ease = r._yEase), (r._yEase = n), (r._yoyo = i))), (r = r._next);
        },
        Pt = function (e, t) {
            return (
                (e &&
                        ...
                        : Ct[e] ||
                          (function (e) {
                              var t,
                                  ...
                                  s = (e + '').split('('),
                                  a = Ct[s[0]];
                              return a && s.length > 1 && a.config ? a.config.apply(null, ~e.indexOf('{') ? [Mt(s[1])] : ((t = e), (i = t.indexOf('(') + 1), (n = t.indexOf(')')), (r = t.indexOf('(', i)), t.substring(i, ~r && r < n ? t.indexOf(')', n + 1) : n)).split(',').map(_e)) : Ct._CE && St.test(e) ? Ct._CE('', e) : a;
                          })(e))) ||
                t
            );
        },
        At = function (e, t, i, n) {
            ...
            return (
                ce(e, function (e) {
                    for (var t in ((Ct[e] = H[e] = s), (Ct[(r = e.toLowerCase())] = i), s)) Ct[r + ('easeIn' === t ? '.in' : 'easeOut' === t ? '.out' : '.inOut')] = Ct[e + '.' + t] = s[t];
                }),
                s
            );
        },
    ...
    ce('Linear,Quad,Cubic,Quart,Quint,Strong', function (e, t) {
        ...
        At(
            ...
            (g = function (e) {
                return e < m ? h * e * e : e < 0.7272727272727273 ? h * Math.pow(e - 1.5 / f, 2) + 0.75 : e < 0.9090909090909092 ? h * (e -= 2.25 / f) * e + 0.9375 : h * Math.pow(e - 2.625 / f, 2) + 0.984375;
            })
        ),
        At('Expo', function (e) {
    ...
    var zt = function (e, t) {
            (this.id = x++), (e._gsap = this), (this.target = e), (this.harness = t), (this.get = t ? t.get : ue), (this.set = t ? t.getSetter : Jt);
        },
        It = (function () {
            function e(e) {
                (this.vars = e), (this._delay = +e.delay || 0), (this._repeat = e.repeat === 1 / 0 ? -2 : e.repeat || 0) && ((this._rDelay = e.repeatDelay || 0), (this._yoyo = !!e.yoyo || !!e.yoyoEase)), (this._ts = 1), qe(this, +e.duration, 1, 1), (this.data = e.data), r && ((this._ctx = r), r.data.push(this)), p || Tt.wake();
            }
            var t = e.prototype;
            return (
                (t.delay = function (e) {
                ...
                (t.totalTime = function (e, t) {
                    ...
                    if (i && i.smoothChildTiming && this._ts) {
                        for (ze(this, e), !i._dp || i.parent || Ie(i, this); i && i.parent; ) i.parent._time !== i._start + (i._ts >= 0 ? i._tTime / i._ts : (i.totalDuration() - i._tTime) / -i._ts) && i.totalTime(i._tTime, !0), (i = i.parent);
                    ...
                    return (this._tTime !== e || (!this._dur && !t) || (this._initted && Math.abs(this._zTime) === w) || (!e && !this._initted && (this.add || this._ptLookup))) && (this._ts || (this._pTime = e), ve(this, e, t)), this;
                }),
                (t.time = function (e, t) {
                    return arguments.length ? this.totalTime(Math.min(this.totalDuration(), e + Ae(this)) % (this._dur + this._rDelay) || (e ? this._dur : 0), t) : this._time;
                }),
                ...
                (t.paused = function (e) {
                    return arguments.length
                        ? (this._ps !== e && ((this._ps = e), e ? ((this._pTime = this._tTime || Math.max(-this._delay, this.rawTime())), (this._ts = this._act = 0)) : (xt(), (this._ts = this._rts), this.totalTime(this.parent && !this.parent.smoothChildTiming ? this.rawTime() : this._tTime || this._pTime, 1 === this.progress() && Math.abs(this._zTime) !== w && (this._tTime -= w)))), this)
                        : this._ps;
                }),
                ...
                (t.revert = function (e) {
                    void 0 === e && (e = J);
                    var t = n;
                    return (n = e), (this._initted || this._startAt) && (this.timeline && this.timeline.revert(e), this.totalTime(-0.01, e.suppressEvents)), 'nested' !== this.data && !1 !== e.kill && this.kill(), (n = t), this;
                }),
                ...
                (t.then = function (e) {
                    ...
                    return new Promise(function (i) {
                        var n = k(e) ? e : ye,
                            r = function () {
                                var e = t.then;
                                (t.then = null), k(n) && (n = n(t)) && (n.then || n === t) && (t.then = e), i(n), (t.then = e);
                            };
    ...
    we(It.prototype, { _time: 0, _start: 0, _end: 0, _tTime: 0, _tDur: 0, _dirty: 0, _repeat: 0, _yoyo: !1, parent: null, _initted: !1, _rDelay: 0, _ts: 1, _dp: 0, ratio: 0, _zTime: -1e-8, _prom: 0, _ps: !1, _rts: 1 });
    var Bt = (function (i) {
        function r(t, n) {
            var r;
            return void 0 === t && (t = {}), ((r = i.call(this, t) || this).labels = {}), (r.smoothChildTiming = !!t.smoothChildTiming), (r.autoRemoveChildren = !!t.autoRemoveChildren), (r._sort = L(t.sortChildren)), s && Be(t.parent || s, e(r), n), t.reversed && r.reverse(), t.paused && r.paused(!0), t.scrollTrigger && Fe(e(r), t.scrollTrigger), r;
        }
        t(r, i);
        var a = r.prototype;
        return (
            ...
            (a.set = function (e, t, i) {
                return (t.duration = 0), (t.parent = this), Ce(t).repeatDelay || (t.repeat = 0), (t.immediateRender = !!t.immediateRender), new Wt(e, t, Ve(this, i), 1), this;
            }),
            (a.call = function (e, t, i) {
                return Be(this, Wt.delayedCall(0, e, t), i);
            }),
            (a.staggerTo = function (e, t, i, n, r, s, a) {
                return (i.duration = t), (i.stagger = i.stagger || n), (i.onComplete = s), (i.onCompleteParams = a), (i.parent = this), new Wt(e, i, Ve(this, r)), this;
            }),
            (a.staggerFrom = function (e, t, i, n, r, s, a) {
                return (i.runBackwards = 1), (Ce(i).immediateRender = L(i.immediateRender)), this.staggerTo(e, t, i, n, r, s, a);
            }),
            (a.staggerFromTo = function (e, t, i, n, r, s, a, o) {
                return (n.startAt = i), (Ce(n).immediateRender = L(n.immediateRender)), this.staggerTo(e, t, n, r, s, a, o);
            }),
            (a.render = function (e, t, i) {
                ...
                if ((this !== s && b > _ && e >= 0 && (b = _), b !== this._tTime || i || T)) {
                    if ((v !== this._time && y && ((b += this._time - v), (e += this._time - v)), (r = b), (h = this._start), (u = !(p = this._ts)), T && (y || (v = this._zTime), (e || !t) && (this._zTime = e)), this._repeat)) {
                        if (((m = this._yoyo), (d = y + this._rDelay), this._repeat < -1 && e < 0)) return this.totalTime(100 * d + e, t, i);
                        if (((r = he(b % d)), b === _ ? ((l = this._repeat), (r = y)) : ((l = ~~(b / d)) && l === b / d && ((r = y), l--), r > y && (r = y)), (f = Le(this._tTime, d)), !v && this._tTime && f !== l && this._tTime - f * d - this._dur <= 0 && (f = l), m && 1 & l && ((r = y - r), (g = 1)), l !== f && !this._lock)) {
                            var x = m && 1 & f,
                                C = x === (m && 1 & l);
                            if ((l < f && (x = !x), (v = x ? 0 : y), (this._lock = 1), (this.render(v || (g ? 0 : he(l * d)), t, !y)._lock = 0), (this._tTime = b), !t && this.parent && dt(this, 'onRepeat'), this.vars.repeatRefresh && !g && (this.invalidate()._lock = 1), (v && v !== this._time) || u !== !this._ts || (this.vars.onRepeat && !this.parent && !this._act))) return this;
                            if (((y = this._dur), (_ = this._tDur), C && ((this._lock = 2), (v = x ? y : -1e-4), this.render(v, !0), this.vars.repeatRefresh && !g && this.invalidate()), (this._lock = 0), !this._ts && !u)) return this;
                            Ot(this, g);
                        }
                    }
                    if (
                    ...
                    if (r >= v && e >= 0)
                        for (a = this._first; a; ) {
                            if (((o = a._next), (a._act || r >= a._start) && a._ts && c !== a)) {
                                ...
                                if ((a.render(a._ts > 0 ? (r - a._start) * a._ts : (a._dirty ? a.totalDuration() : a._tDur) + (r - a._start) * a._ts, t, i), r !== this._time || (!this._ts && !u))) {
                        ...
                        for (var S = e < 0 ? e : r; a; ) {
                            if (((o = a._prev), (a._act || S <= a._end) && a._ts && c !== a)) {
                                if (a.parent !== this) return this.render(e, t, i);
                                if ((a.render(a._ts > 0 ? (S - a._start) * a._ts : (a._dirty ? a.totalDuration() : a._tDur) + (S - a._start) * a._ts, t, i || (n && (a._initted || a._startAt))), r !== this._time || (!this._ts && !u))) {
                    ...
                    if (c && !t && (this.pause(), (c.render(r >= v ? 0 : -1e-8)._zTime = r >= v ? 1 : -1), this._ts)) return (this._start = h), De(this), this.render(e, t, i);
                    this._onUpdate && !t && dt(this, 'onUpdate', !0),
                        ((b === _ && this._tTime >= this.totalDuration()) || (!b && v)) &&
                            ((h !== this._start && Math.abs(p) === Math.abs(this._ts)) || this._lock || ((e || !y) && ((b === _ && this._ts > 0) || (!b && this._ts < 0)) && Me(this, 1), t || (e < 0 && !v) || (!b && !v && _) || (dt(this, b === _ && e >= 0 ? 'onComplete' : 'onReverseComplete', !0), this._prom && !(b < _ && this.timeScale() > 0) && this._prom())));
                }
                return this;
            }),
            (a.add = function (e, t) {
            ...
            (a.getChildren = function (e, t, i, n) {
                ...
                for (var r = [], s = this._first; s; ) s._start >= n && (s instanceof Wt ? t && r.push(s) : (i && r.push(s), e && r.push.apply(r, s.getChildren(!0, t, i)))), (s = s._next);
                return r;
            }),
            ...
            (a.remove = function (e) {
                return M(e) ? this.removeLabel(e) : k(e) ? this.killTweensOf(e) : (Ee(this, e), e === this._recent && (this._recent = this._last), ke(this));
            }),
            (a.totalTime = function (e, t) {
                return arguments.length ? ((this._forcing = 1), !this._dp && this._ts && (this._start = he(Tt.time - (this._ts > 0 ? e / this._ts : (this.totalDuration() - e) / -this._ts))), i.prototype.totalTime.call(this, e, t), (this._forcing = 0), this) : this._tTime;
            }),
            ...
            (a.getTweensOf = function (e, t) {
                for (var i, n = [], r = Ze(e), s = this._first, a = O(t); s; ) s instanceof Wt ? me(s._targets, r) && (a ? (!Ft || (s._initted && s._ts)) && s.globalTime(0) <= t && s.globalTime(s.totalDuration()) > t : !t || s.isActive()) && n.push(s) : (i = s.getTweensOf(r, t)).length && n.push.apply(n, i), (s = s._next);
                return n;
            }),
                ...
                if (a._dirty) {
                    for (n = a.parent; o; )
                        (t = o._prev),
                            ...
                            (i = o._start) > l && a._sort && o._ts && !a._lock ? ((a._lock = 1), (Be(a, o, i - o._delay, 1)._lock = 0)) : (l = i),
                            i < 0 && o._ts && ((r -= i), ((!n && !a._dp) || (n && n.smoothChildTiming)) && ((a._start += i / a._ts), (a._time -= i), (a._tTime -= i)), a.shiftChildren(-i, !1, -Infinity), (l = 0)),
    ...
    var Ft,
        ...
        Nt = function (e, t, i, n, r, s, a) {
            var o,
                ...
                g = 0,
                v = 0;
            for (m.b = i, m.e = n, i += '', (h = ~(n += '').indexOf('random(')) && (n = at(n)), s && (s((f = [i, n]), e, t), (i = f[0]), (n = f[1])), l = i.match(N) || []; (o = N.exec(n)); )
                (u = o[0]), (c = n.substring(g, o.index)), d ? (d = (d + 1) % 5) : 'rgba(' === c.substr(-5) && (d = 1), u !== l[v++] && ((p = parseFloat(l[v - 1]) || 0), (m._pt = { _next: m._pt, p: c || 1 === v ? c : ',', s: p, c: '=' === u.charAt(1) ? fe(p, u) - p : parseFloat(u) - p, m: d && d < 4 ? Math.round : 0 }), (g = N.lastIndex));
            return (m.c = g < n.length ? n.substring(g, n.length) : ''), (m.fp = a), (G.test(n) || h) && (m.e = 0), (this._pt = m), m;
        },
        Gt = function (e, t, i, n, r, s, a, o, l, d) {
            k(n) && (n = n(r || 0, e, s));
            var u,
                c = e[t],
                p = 'get' !== i ? i : k(c) ? (l ? e[t.indexOf('set') || !k(e['get' + t.substr(3)]) ? t : 'get' + t.substr(3)](l) : e[t]()) : c,
                h = k(c) ? (l ? Qt : Kt) : Ut;
            if ((M(n) && (~n.indexOf('random(') && (n = at(n)), '=' === n.charAt(1) && ((u = fe(p, n) + (Ue(p) || 0)) || 0 === u) && (n = u)), !d || p !== n || Rt))
                return isNaN(p * n) || '' === n ? (!c && !(t in e) && X(t, n), Nt.call(this, e, t, p, n, h, o || v.stringFilter, l)) : ((u = new li(this._pt, e, t, +p || 0, n - (p || 0), 'boolean' == typeof c ? ti : ei, 0, h)), l && (u.fp = l), a && u.modifier(a, this, e), (this._pt = u));
        },
                ...
                !1 !==
                    (a = new ne[e]()).init(
                        ...
                        a.rawVars
                            ? t[e]
                            : (function (e, t, i, n, r) {
                                  if ((k(e) && (e = Vt(e, r, t, i, n)), !A(e) || (e.style && e.nodeType) || I(e) || z(e))) return M(e) ? Vt(e, r, t, i, n) : e;
                                  var s,
                                      a = {};
        ...
        jt = function e(t, r, a) {
            var o,
                ...
                q = t.timeline;
            if ((q && (!D || !C) && (C = 'none'), (t._ease = Pt(C, _.ease)), (t._yEase = $ ? kt(Pt(!0 === $ ? C : $, _.ease)) : 0), $ && t._yoyo && !t._repeat && (($ = t._yEase), (t._yEase = t._ease), (t._ease = $)), (t._from = !q && !!x.runBackwards), !q || (D && !x.stagger))) {
                if (((b = (f = F[0] ? de(F[0]).harness : 0) && x[f.prop]), (o = xe(x, ee)), B && (B._zTime < 0 && B.progress(1), r < 0 && A && E && !z ? B.render(-1, !0) : B.revert(A && I ? Z : Q), (B._lazy = 0)), S)) {
                    if ((Me((t._startAt = Wt.set(F, we({ data: 'isStart', overwrite: !1, parent: R, immediateRender: !0, lazy: !B && L(M), startAt: null, delay: 0, onUpdate: k, onUpdateParams: O, callbackScope: P, stagger: 0 }, S)))), (t._startAt._dp = 0), (t._startAt._sat = t), r < 0 && (n || (!E && !z)) && t._startAt.revert(Z), E && I && r <= 0 && a <= 0)) return void (r && (t._zTime = r));
                } else if (A && I && !B)
                    if ((r && (E = !1), (d = we({ overwrite: !1, data: 'isFromStart', lazy: E && !B && L(M), immediateRender: E, stagger: 0, parent: R }, o)), b && (d[f.prop] = b), Me((t._startAt = Wt.set(F, d))), (t._startAt._dp = 0), (t._startAt._sat = t), r < 0 && (n ? t._startAt.revert(Z) : t._startAt.render(-1, !0)), (t._zTime = r), E)) {
                        if (!r) return;
                ...
                for (t._pt = t._ptCache = 0, M = (I && L(M)) || (M && !I), l = 0; l < F.length; l++) {
                    if (
                        ...
                        for (d in o) ne[d] && (m = qt(d, o, t, v, c, N)) ? m.priority && (p = 1) : (g[d] = u = Gt.call(t, c, d, 'get', o[d], v, N, 0, x.stringFilter));
                    t._op && t._op[l] && t.kill(c, t._op[l]), G && t._pt && ((Ft = t), s.killTweensOf(c, g, t.globalTime(r)), (T = !t.parent), (Ft = 0)), t._pt && M && (ie[h.id] = 1);
                }
    ...
    var Wt = (function (r) {
        function a(t, n, a, o) {
            ...
            if (((l._targets = P.length ? le(P) : W('GSAP target ' + t + ' not found. https://greensock.com', !v.nullTargetWarn) || []), (l._ptLookup = []), (l._overwrite = x), C || T || D(y) || D(w))) {
                if (((n = l.vars), (d = l.timeline = new Bt({ data: 'nested', defaults: S || {}, targets: k && 'nested' === k.data ? k.vars.targets : P })).kill(), (d.parent = d._dp = e(l)), (d._start = 0), T || D(y) || D(w))) {
                    if (((p = P.length), (m = T && tt(T)), A(T))) for (h in T) ~Yt.indexOf(h) && (g || (g = {}), (g[h] = T[h]));
                    for (u = 0; u < p; u++) ((c = xe(n, Xt)).stagger = 0), M && (c.yoyoEase = M), g && be(c, g), (f = P[u]), (c.duration = +Vt(y, e(l), u, f, P)), (c.delay = (+Vt(w, e(l), u, f, P) || 0) - l._delay), !T && 1 === p && c.delay && ((l._delay = w = c.delay), (l._start += w), (c.delay = 0)), d.to(f, c, m ? m(u, f, P) : 0), (d._ease = Ct.none);
                    ...
                    if (I(C))
                        ...
                        for (h in c)
                            for (
                                ...
                                ((F = { ease: (B = $[u]).e, duration: ((B.t - (u ? $[u - 1].t : 0)) / 100) * y })[h] = B.v), d.to(P, F, R), (R += F.duration);
                        d.duration() < y && d.to({}, { duration: y - d.duration() });
                    }
                }
                y || l.duration((y = d.duration()));
            } else l.timeline = 0;
            return !0 !== x || i || ((Ft = e(l)), s.killTweensOf(P), (Ft = 0)), Be(k, e(l), a), n.reversed && l.reverse(), n.paused && l.paused(!0), (b || (!y && !C && l._start === he(k._time) && L(b) && Pe(e(l)) && 'nested' !== k.data)) && ((l._tTime = -1e-8), l.render(Math.max(0, -w) || 0)), E && Fe(e(l), E), l;
        }
        t(a, r);
        var o = a.prototype;
        return (
                ...
                if (m) {
                    if (v !== this._tTime || !e || i || (!this._initted && this._tTime) || (this._startAt && this._zTime < 0 !== g)) {
                        if (((r = v), (c = this.timeline), this._repeat)) {
                            ...
                            if (((r = he(v % o)), v === f ? ((a = this._repeat), (r = m)) : ((a = ~~(v / o)) && a === v / o && ((r = m), a--), r > m && (r = m)), (d = this._yoyo && 1 & a) && ((p = this._yEase), (r = m - r)), (l = Le(this._tTime, o)), r === h && !i && this._initted)) return (this._tTime = v), this;
                            a !== l && (c && this._yEase && Ot(c, d), !this.vars.repeatRefresh || d || this._lock || ((this._lock = i = 1), (this.render(he(o * a), !0).invalidate()._lock = 0)));
                        }
                        if (!this._initted) {
                        ...
                        if (((this._tTime = v), (this._time = r), !this._act && this._ts && ((this._act = 1), (this._lazy = 0)), (this.ratio = u = (p || this._ease)(r / m)), this._from && (this.ratio = u = 1 - u), r && !h && !t && !a && (dt(this, 'onStart'), this._tTime !== v))) return this;
                        for (s = this._pt; s; ) s.r(u, s.d), (s = s._next);
                        (c && c.render(e < 0 ? e : !r && d ? -1e-8 : c._dur * c._ease(r / this._dur), t, i)) || (this._startAt && (this._zTime = e)),
                            this._onUpdate && !t && (g && Oe(this, e, 0, i), dt(this, 'onUpdate')),
                            this._repeat && a !== l && this.vars.onRepeat && !t && this.parent && dt(this, 'onRepeat'),
                            (v !== this._tDur && v) || this._tTime !== v || (g && !this._onUpdate && Oe(this, e, 0, !0), (e || !m) && ((v === this._tDur && this._ts > 0) || (!v && this._ts < 0)) && Me(this, 1), t || (g && !h) || !(v || h || d) || (dt(this, v === f ? 'onComplete' : 'onReverseComplete', !0), this._prom && !(v < f && this.timeScale() > 0) && this._prom()));
                    }
                } else
                    !(function (e, t, i, r) {
                        var s,
                            ...
                            o,
                            l = e.ratio,
                            d = t < 0 || (!t && ((!e._start && Ne(e) && (e._initted || !Ge(e))) || ((e._ts < 0 || e._dp._ts < 0) && !Ge(e)))) ? 0 : 1,
                            u = e._rDelay,
                            c = 0;
                        if ((u && e._repeat && ((c = We(0, e._tDur, t)), (a = Le(c, u)), e._yoyo && 1 & a && (d = 1 - d), a !== Le(e._tTime, u) && ((l = 1 - d), e.vars.repeatRefresh && e._initted && e.invalidate())), d !== l || n || r || e._zTime === w || (!t && e._zTime))) {
                            if (!e._initted && Re(e, t, r, i, c)) return;
                            for (o = e._zTime, e._zTime = t || (i ? w : 0), i || (i = t && !o), e.ratio = d, e._from && (d = 1 - d), e._time = 0, e._tTime = c, s = e._pt; s; ) s.r(d, s.d), (s = s._next);
                            t < 0 && Oe(e, t, 0, !0), e._onUpdate && !i && dt(e, 'onUpdate'), c && e._repeat && !i && e.parent && dt(e, 'onRepeat'), (t >= e._tDur || t < 0) && e.ratio === d && (d && Me(e, 1), i || n || (dt(e, d ? 'onComplete' : 'onReverseComplete', !0), e._prom && e._prom()));
                    ...
                    (function (e, t, i, n, r, s, a) {
                        ...
                        if (!c)
                            for (c = e._ptCache[t] = [], d = e._ptLookup, u = e._targets.length; u--; ) {
                                if ((o = d[u][t]) && o.d && o.d._pt) for (o = o.d._pt; o && o.p !== t && o.fp !== t; ) o = o._next;
                                if (!o) return (Rt = 1), (e.vars[t] = '+=0'), jt(e, a), (Rt = 0), 1;
                                c.push(o);
                            }
                        for (u = c.length; u--; ) ((o = (l = c[u])._pt || l).s = (!n && 0 !== n) || r ? o.s + (n || 0) + s * o.c : n), (o.c = i - o.s), l.e && (l.e = pe(i) + Ue(l.e)), l.b && (l.b = o.s + Ue(l.b));
                    })(this, e, t, i, n, this._ease(r / this._dur), r)
                        ? this.resetTo(e, t, i, n)
                        : (ze(this, 0), this.parent || Se(this._dp, this, '_first', '_last', this._dp._sort ? '_start' : 0), this.render(0))
                );
            }),
            (o.kill = function (e, t) {
                ...
                if (this.timeline) {
                    ...
                    return this.timeline.killTweensOf(e, t, Ft && !0 !== Ft.vars.overwrite)._first || ut(this), this.parent && i !== this.timeline.totalDuration() && qe(this, (this._dur * this.timeline._tDur) / i, 0, 1), this;
                }
                var n,
                    r,
                    s,
                ...
                for (
                        ...
                        'all' !== t &&
                            ...
                            (t = (function (e, t) {
                                var i,
                                    ...
                                    o = a && a.aliases;
                                if (!o) return t;
                                for (n in ((i = be({}, t)), o)) if ((n in i)) for (r = (s = o[n].split(',')).length; r--; ) i[s[r]] = i[n];
                                return i;
                            })(u, t))),
                        d = u.length;
                    d--;
                    ...
                    if (~c.indexOf(u[d])) for (o in ((r = p[d]), 'all' === t ? ((n[d] = t), (a = r), (s = {})) : ((s = n[d] = n[d] || {}), (a = t)), a)) (l = r && r[o]) && (('kill' in l.d && !0 !== l.d.kill(o)) || Ee(this, l, '_pt'), delete r[o]), 'all' !== s && (s[o] = 1);
            ...
            (a.delayedCall = function (e, t, i, n) {
                return new a(t, 0, { immediateRender: !1, lazy: !1, overwrite: !1, delay: e, onComplete: t, onReverseComplete: t, onCompleteParams: i, onReverseCompleteParams: i, callbackScope: n });
            }),
    ...
    var Ut = function (e, t, i) {
        ...
        si = function (e) {
            for (var t, i, n = this._pt; n; ) (i = n._next), (n.p === e && !n.op) || n.op === e ? Ee(this, n, '_pt') : n.dep || (t = 1), (n = i);
            return !t;
        },
        ai = function (e, t, i, n) {
        ...
        li = (function () {
            function e(e, t, i, n, r, s, a, o, l) {
                (this.t = t), (this.s = n), (this.c = r), (this.p = i), (this.r = s || ei), (this.d = a || this), (this.set = o || Ut), (this.pr = l || 0), (this._next = e), e && (e._prev = this);
            }
            return (
    ...
    ce(oe + 'parent,duration,ease,delay,overwrite,runBackwards,startAt,yoyo,immediateRender,repeat,repeatDelay,data,paused,reversed,lazy,callbackScope,stringFilter,id,yoyoEase,stagger,inherit,repeatRefresh,keyframes,autoRevert,scrollTrigger', function (e) {
        return (ee[e] = 1);
    }),
    ...
    var di = [],
        ...
        mi = (function () {
            function e(e, t) {
                (this.selector = t && Je(t)), (this.data = []), (this._r = []), (this.isReverted = !1), e && this.add(e);
            }
            var t = e.prototype;
            return (
                    ...
                    var n = this,
                        s = function () {
                            var e,
                                s = r,
                                a = n.selector;
                            return s && s !== n && s.data.push(n), i && (n.selector = Je(i)), (r = n), (e = t.apply(n, arguments)), k(e) && n._r.push(e), (r = s), (n.selector = a), (n.isReverted = !1), e;
                        };
                ...
                (t.getTweens = function () {
                    ...
                    return (
                        this.data.forEach(function (i) {
                            return i instanceof e ? t.push.apply(t, i.getTweens()) : i instanceof Wt && !(i.parent && 'nested' === i.parent.data) && t.push(i);
                        }),
                        t
                    );
                }),
            ...
            return (
                (t.add = function (e, t, i) {
                    ...
                    var n,
                        ...
                        l = (o.conditions = {});
                    for (r in (this.contexts.push(o), (t = o.add('onMatch', t)), (o.queries = e), e)) 'all' === r ? (s = 1) : (n = a.matchMedia(e[r])) && (di.indexOf(o) < 0 && di.push(o), (l[r] = n.matches) && (s = 1), n.addListener ? n.addListener(fi) : n.addEventListener('change', fi));
                    return s && t(o), this;
                }),
                (t.revert = function (e) {
                    this.kill(e || {});
        ...
        vi = {
            ...
            exportRoot: function (e, t) {
                ...
                var i,
                    n,
                    r = new Bt(e);
                for (r.smoothChildTiming = L(e.smoothChildTiming), s.remove(r), r._dp = 0, r._time = r._tTime = s._time, i = s._first; i; ) (n = i._next), (!t && !i._dur && i instanceof Wt && i.vars.onComplete === i._targets[0]) || Be(r, i, i._start - i._delay), (i = n);
                return Be(s, r, 0), r;
            },
                    ...
                    n._onInit = function (e) {
                        ...
                        !(function (e, t) {
                            var i,
                                ...
                                r,
                                s = e._targets;
                            for (i in t) for (n = s.length; n--; ) (r = e._ptLookup[n][i]) && (r = r.d) && (r._pt && (r = _i(r, i)), r && r.modifier && r.modifier(t[i], e, s[n], i));
                        })(e, i);
                    };
                },
            };
    ...
    (Wt.version = Bt.version = wi.version = '3.11.5'), (d = 1), $() && xt(), Ct.Power0, Ct.Power1, Ct.Power2, Ct.Power3, Ct.Power4, Ct.Linear, Ct.Quad, Ct.Cubic, Ct.Quart, Ct.Quint, Ct.Strong, Ct.Elastic, Ct.Back, Ct.SteppedEase, Ct.Bounce, Ct.Sine, Ct.Expo, Ct.Circ;
    var bi,
        Ti,
        xi,
        Ci,
        ...
        Ji = function () {
            var e,
                ...
                r = n.style,
                s = n._gsap;
            for (e = 0; e < i.length; e += 3) i[e + 1] ? (n[i[e]] = i[e + 2]) : i[e + 2] ? (r[i[e]] = i[e + 2]) : r.removeProperty('--' === i[e].substr(0, 2) ? i[e] : i[e].replace($i, '-$1').toLowerCase());
            if (this.tfm) {
                for (t in this.tfm) s[t] = this.tfm[t];
                s.svg && (s.renderTransform(), n.setAttribute('data-svg-origin', this.svgo || '')), ((e = Mi()) && e.isStart) || r[Ui] || (Zi(r), (s.uncache = 1));
            }
        },
        en = function (e, t) {
        ...
        tn = function (e, t) {
            var i = Ti.createElementNS ? Ti.createElementNS((t || 'http://www.w3.org/1999/xhtml').replace(/^https/, 'http'), e) : Ti.createElement(e);
            return i.style ? i : Ti.createElement(e);
        },
        nn = function e(t, i, n) {
            var r = getComputedStyle(t);
            return r[i] || r.getPropertyValue(i.replace($i, '-$1').toLowerCase()) || r.getPropertyValue(i) || (!n && e(t, sn(i) || i, 1)) || '';
        },
        ...
        an = function () {
            'undefined' != typeof window && window.document && ((bi = window), (Ti = bi.document), (xi = Ti.documentElement), (Si = tn('div') || { style: {} }), tn('div'), (Ui = sn(Ui)), (Ki = Ui + 'Origin'), (Si.style.cssText = 'border-width:0;line-height:0;position:absolute;padding:0'), (ki = !!sn('perspective')), (Mi = wi.core.reverting), (Ci = 1));
        },
        on = function e(t) {
            var i,
                n = tn('svg', (this.ownerSVGElement && this.ownerSVGElement.getAttribute('xmlns')) || 'http://www.w3.org/2000/svg'),
                r = this.parentNode,
                s = this.nextSibling,
            ...
            return r && (s ? r.insertBefore(this, s) : r.appendChild(this)), xi.removeChild(n), (this.style.cssText = a), i;
        },
        ln = function (e, t) {
        ...
        dn = function (e) {
            ...
            return (t && (t.width || t.height)) || e.getBBox === on || (t = on.call(e, !0)), !t || t.width || t.x || t.y ? t : { x: +ln(e, ['x', 'cx', 'x1']) || 0, y: +ln(e, ['y', 'cy', 'y1']) || 0, width: 0, height: 0 };
        },
        un = function (e) {
        ...
        cn = function (e, t) {
            if (t) {
                var i = e.style;
                t in Oi && t !== Ki && (t = Ui), i.removeProperty ? (('ms' !== t.substr(0, 2) && 'webkit' !== t.substr(0, 6)) || (t = '-' + t), i.removeProperty(t.replace($i, '-$1').toLowerCase())) : i.removeAttribute(t);
            }
        },
                  ...
                  (!v && '%' !== u) || (!Oi[i] && !~i.indexOf('adius'))
                      ? ((c[p ? 'width' : 'height'] = m + (g ? u : r)),
                        ...
                        (o = a._gsap) && v && o.width && p && o.time === Tt.time && !o.uncache
                            ? pe((d / o.width) * m)
                            : ((v || '%' === u) && !fn[nn(a, 'display')] && (c.position = nn(t, 'position')), a === t && (c.position = 'static'), a.appendChild(Si), (s = Si[f]), a.removeChild(Si), (c.position = 'absolute'), p && v && (((o = de(a)).time = Tt.time), (o.width = a[f])), pe(g ? (s * d) / m : s && d ? (m / s) * d : 0)))
        ...
        gn = function (e, t, i, n) {
            ...
            return (
                ...
                Oi[t] && 'transform' !== t ? ((r = Mn(e, n)), (r = 'transformOrigin' !== t ? r[t] : r.svg ? r.origin : kn(nn(e, Ki)) + ' ' + r.zOrigin + 'px')) : (!(r = e.style[t]) || 'auto' === r || n || ~(r + '').indexOf('calc(')) && (r = (wn[t] && wn[t](e, t, i)) || nn(e, t) || ue(e, t) || ('opacity' === t ? 1 : 0)),
        ...
        vn = function (e, t, i, n) {
            ...
            var a,
                ...
                y = 0,
                w = 0;
            if (((_.b = i), (_.e = n), (i += ''), 'auto' == (n += '') && ((e.style[t] = n), (n = nn(e, t) || n), (e.style[t] = i)), bt((a = [i, n])), (n = a[1]), (l = (i = a[0]).match(R) || []), (n.match(R) || []).length)) {
                for (; (o = R.exec(n)); )
                    (p = o[0]),
                        ...
                        p !== (c = l[w++] || '') &&
                            ...
                            g !== m && (d = mn(e, t, c, m) || 0),
                            (_._pt = { _next: _._pt, p: f || 1 === w ? f : ',', s: d, c: h - d, m: (u && u < 4) || 'zIndex' === t ? Math.round : 0 }));
        ...
        yn = function (e, t) {
            if (t.tween && t.tween._time === t.tween._dur) {
                ...
                else for (r = (o = o.split(',')).length; --r > -1; ) (i = o[r]), Oi[i] && ((n = 1), (i = 'transformOrigin' === i ? Ki : Ui)), cn(s, i);
        ...
        Sn = function (e, t) {
            ...
            return a.svg && e.getAttribute('transform')
                ? '1,0,0,1,0,0' === (l = [(r = e.transform.baseVal.consolidate().matrix).a, r.b, r.c, r.d, r.e, r.f]).join(',')
                    ? bn
                    : l
                : (l !== bn || e.offsetParent || e === xi || a.svg || ((r = o.display), (o.display = 'block'), ((i = e.parentNode) && e.offsetParent) || ((s = 1), (n = e.nextElementSibling), xi.appendChild(e)), (l = Cn(e)), r ? (o.display = r) : cn(e, 'display'), s && (n ? i.insertBefore(e, n) : i ? i.appendChild(e) : xi.removeChild(e))),
        ...
        En = function (e, t, i, n, r, s) {
            var a,
                ...
                T = parseFloat(b[0]) || 0,
                x = parseFloat(b[1]) || 0;
            i ? u !== bn && (o = m * _ - g * v) && ((l = T * (-g / o) + x * (m / o) - (m * w - g * y) / o), (T = T * (_ / o) + x * (-v / o) + (v * w - _ * y) / o), (x = l)) : ((T = (a = dn(e)).x + (~b[0].indexOf('%') ? (T / 100) * a.width : T)), (x = a.y + (~(b[1] || b[0]).indexOf('%') ? (x / 100) * a.height : x))),
                n || (!1 !== n && d.smooth) ? ((y = T - c), (w = x - p), (d.xOffset = h + (y * m + w * v) - y), (d.yOffset = f + (y * g + w * _) - w)) : (d.xOffset = d.yOffset = 0),
                (d.xOrigin = T),
                (d.yOrigin = x),
                (d.smooth = !!n),
                (d.origin = t),
                ...
                (e.style[Ki] = '0px 0px'),
                s && (pn(s, d, 'xOrigin', c, T), pn(s, d, 'yOrigin', p, x), pn(s, d, 'xOffset', h, d.xOffset), pn(s, d, 'yOffset', f, d.yOffset)),
        ...
        Mn = function (e, t) {
            ...
            return (
                ...
                (i.svg = !(!e.getCTM || !un(e))),
                N.translate &&
                    (('none' === N.translate && 'none' === N.scale && 'none' === N.rotate) || (I[Ui] = ('none' !== N.translate ? 'translate3d(' + (N.translate + ' 0 0').split(' ').slice(0, 3).join(', ') + ') ' : '') + ('none' !== N.rotate ? 'rotate(' + N.rotate + ') ' : '') + ('none' !== N.scale ? 'scale(' + N.scale.split(' ').join(',') + ') ' : '') + ('none' !== N[Ui] ? N[Ui] : '')),
                    (I.scale = I.rotate = I.translate = 'none')),
                (g = Sn(e, i.svg)),
                i.svg && (i.uncache ? ((k = e.getBBox()), (G = i.xOrigin - k.x + 'px ' + (i.yOrigin - k.y) + 'px'), (M = '')) : (M = !t && e.getAttribute('data-svg-origin')), En(e, M || G, !!M || i.originIsAbsolute, !1 !== i.smooth, g)),
                (f = i.xOrigin || 0),
                (m = i.yOrigin || 0),
                g !== bn &&
                    ((b = g[0]),
                    ...
                    (r = E = g[5]),
                    6 === g.length
                        ? ((a = Math.sqrt(b * b + T * T)), (o = Math.sqrt(C * C + x * x)), (l = b || T ? Li(T, b) * Pi : 0), (c = x || C ? Li(x, C) * Pi + l : 0) && (o *= Math.abs(Math.cos(c * Ai))), i.svg && ((n -= f - (f * b + m * x)), (r -= m - (f * T + m * C))))
                        : ((z = g[6]),
                          ($ = g[7]),
                          (P = g[8]),
                          (A = g[9]),
                          ...
                          (s = g[14]),
                          (d = (_ = Li(z, L)) * Pi),
                          _ && ((M = S * (y = Math.cos(-_)) + P * (w = Math.sin(-_))), (k = E * y + A * w), (O = z * y + L * w), (P = S * -w + P * y), (A = E * -w + A * y), (L = z * -w + L * y), (D = $ * -w + D * y), (S = M), (E = k), (z = O)),
                          (u = (_ = Li(-x, L)) * Pi),
                          _ && ((y = Math.cos(-_)), (D = C * (w = Math.sin(-_)) + D * y), (b = M = b * y - P * w), (T = k = T * y - A * w), (x = O = x * y - L * w)),
                          (l = (_ = Li(T, b)) * Pi),
                          _ && ((M = b * (y = Math.cos(_)) + T * (w = Math.sin(_))), (k = S * y + E * w), (T = T * y - b * w), (E = E * y - S * w), (b = M), (S = k)),
                          ...
                          (h = D ? 1 / (D < 0 ? -D : D) : 0)),
                    i.svg && ((M = e.getAttribute('transform')), (i.forceCSS = e.setAttribute('transform', '') || !xn(nn(e, Ui))), M && e.setAttribute('transform', M))),
                Math.abs(c) > 90 && Math.abs(c) < 270 && (B ? ((a *= -1), (c += l <= 0 ? 180 : -180), (l += l <= 0 ? 180 : -180)) : ((o *= -1), (c += c <= 0 ? 180 : -180))),
                (t = t || i.uncache),
                (i.x = n - ((i.xPercent = n && ((!t && i.xPercent) || (Math.round(e.offsetWidth / 2) === Math.round(-n) ? -50 : 0))) ? (e.offsetWidth * i.xPercent) / 100 : 0) + F),
                (i.y = r - ((i.yPercent = r && ((!t && i.yPercent) || (Math.round(e.offsetHeight / 2) === Math.round(-r) ? -50 : 0))) ? (e.offsetHeight * i.yPercent) / 100 : 0) + F),
                (i.z = s + F),
                (i.scaleX = pe(a)),
                (i.scaleY = pe(o)),
                (i.rotation = pe(l) + R),
        ...
        Dn = function (e, t) {
            ...
            if (_ && (u !== An || d !== An)) {
                var b,
                    ...
                    x = Math.sin(T),
                    C = Math.cos(T);
                (T = parseFloat(u) * Ai), (b = Math.cos(T)), (s = On(v, s, x * b * -_)), (a = On(v, a, -Math.sin(T) * -_)), (o = On(v, o, C * b * -_ + _));
            }
            m !== Ln && (y += 'perspective(' + m + $n),
                (n || r) && (y += 'translate(' + n + '%, ' + r + '%) '),
                (w || s !== Ln || a !== Ln || o !== Ln) && (y += o !== Ln || w ? 'translate3d(' + s + ', ' + a + ', ' + o + ') ' : 'translate(' + s + ', ' + a + $n),
                l !== An && (y += 'rotate(' + l + $n),
                d !== An && (y += 'rotateY(' + d + $n),
                u !== An && (y += 'rotateX(' + u + $n),
        ...
        zn = function (e, t) {
            ...
            (p = parseFloat(p)),
                ...
                p || h ? ((p *= Ai), (h *= Ai), (i = Math.cos(p) * m), (n = Math.sin(p) * m), (r = Math.sin(p - h) * -g), (s = Math.cos(p - h) * g), h && ((f *= Ai), (a = Math.tan(h - f)), (r *= a = Math.sqrt(1 + a * a)), (s *= a), f && ((a = Math.tan(f)), (i *= a = Math.sqrt(1 + a * a)), (n *= a))), (i = pe(i)), (n = pe(n)), (r = pe(r)), (s = pe(s))) : ((i = m), (s = g), (n = r = 0)),
                ((x && !~(u + '').indexOf('px')) || (C && !~(c + '').indexOf('px'))) && ((x = mn(v, 'x', u, 'px')), (C = mn(v, 'y', c, 'px'))),
        ...
        In = function (e, t, i, n, r) {
            var s,
                ...
                u = n + d + 'deg';
            return l && ('short' === (s = r.split('_')[1]) && (d %= o) != d % 180 && (d += d < 0 ? o : -360), 'cw' === s && d < 0 ? (d = ((d + 36e9) % o) - ~~(d / o) * o) : 'ccw' === s && d > 0 && (d = ((d - 36e9) % o) - ~~(d / o) * o)), (e._pt = a = new li(e._pt, t, i, n, d, Fi)), (a.e = u), (a.u = 'deg'), e._props.push(i), a;
        },
        Bn = function (e, t) {
            for (var i in t) e[i] = t[i];
            return e;
        ...
        Fn = function (e, t, i) {
            var n,
                ...
                u = Bn({}, i._gsap),
                c = i.style;
            for (r in (u.svg ? ((s = i.getAttribute('transform')), i.setAttribute('transform', ''), (c[Ui] = t), (n = Mn(i, 1)), cn(i, Ui), i.setAttribute('transform', s)) : ((s = getComputedStyle(i)[Ui]), (c[Ui] = t), (n = Mn(i, 1)), (c[Ui] = s)), Oi))
                (s = u[r]) !== (a = n[r]) && 'perspective,force3D,transformOrigin,svgOrigin'.indexOf(r) < 0 && ((o = Ue(s) !== (d = Ue(a)) ? mn(i, r, s, d) : parseFloat(s)), (l = parseFloat(a)), (e._pt = new li(e._pt, n, r, o, l - o, Bi)), (e._pt.u = d || 0), e._props.push(r));
            Bn(n, u);
        };
        ...
        Gn = {
            ...
            init: function (e, t, i, n, r) {
                var s,
                    ...
                    k = e.style,
                    O = i.vars.startAt;
                for (c in (Ci || an(), (this.styles = this.styles || en(e)), (b = this.styles.props), (this.tween = i), t))
                    if ('autoRound' !== c && ((a = t[c]), !ne[c] || !qt(c, t, i, n, e, r)))
                        if (((d = typeof a), (u = wn[c]), 'function' === d && (d = typeof (a = a.call(i, n, e, r))), 'string' === d && ~a.indexOf('random(') && (a = at(a)), u)) u(this, e, c, a, i) && (w = 1);
                        else if ('--' === c.substr(0, 2)) (s = (getComputedStyle(e).getPropertyValue(c) + '').trim()), (a += ''), (yt.lastIndex = 0), yt.test(s) || ((p = Ue(s)), (h = Ue(a))), h ? p !== h && (s = mn(e, c, s, h) + h) : p && (a += p), this.add(k, 'setProperty', s, a, n, r, 0, 0, c), E.push(c), b.push(c, 0, k[c]);
                        else if ('undefined' !== d) {
                            if (
                                (O && c in O ? ((s = 'function' == typeof O[c] ? O[c].call(i, n, e, r) : O[c]), M(s) && ~s.indexOf('random(') && (s = at(s)), Ue(s + '') || (s += v.units[c] || Ue(gn(e, c)) || ''), '=' === (s + '').charAt(1) && (s = gn(e, c))) : (s = gn(e, c)),
                                (l = parseFloat(s)),
                                (f = 'string' === d && '=' === a.charAt(1) && a.substr(0, 2)) && (a = a.substr(2)),
                                (o = parseFloat(a)),
                                c in Ii && ('autoAlpha' === c && (1 === l && 'hidden' === gn(e, 'visibility') && o && (l = 0), b.push('visibility', 0, k.visibility), pn(this, k, 'visibility', l ? 'inherit' : 'hidden', o ? 'inherit' : 'hidden', !o)), 'scale' !== c && 'transform' !== c && ~(c = Ii[c]).indexOf(',') && (c = c.split(',')[0])),
                                (m = c in Oi))
                            )
                                if ((this.styles.save(c), g || (((_ = e._gsap).renderTransform && !t.parseTransform) || Mn(e, t.parseTransform), (y = !1 !== t.smoothOrigin && _.smooth), ((g = this._pt = new li(this._pt, k, Ui, 0, 1, _.renderTransform, _, 0, -1)).dep = 1)), 'scale' === c))
                                    (this._pt = new li(this._pt, _, 'scaleY', _.scaleY, (f ? fe(_.scaleY, f + o) : o) - _.scaleY || 0, Bi)), (this._pt.u = 0), E.push('scaleY', c), (c += 'X');
                                else {
                                    if ('transformOrigin' === c) {
                                        b.push(Ki, 0, k[Ki]),
                                            ...
                                            (C = x[0]),
                                            (S = x[1] || '50%'),
                                            ('top' !== C && 'bottom' !== C && 'left' !== S && 'right' !== S) || ((T = C), (C = S), (S = T)),
                                            (x[0] = _n[C] || C),
                                            (x[1] = _n[S] || S),
                                            (a = x.join(' ')),
                                            _.svg ? En(e, a, 0, y, 0, this) : ((h = parseFloat(a.split(' ')[2]) || 0) !== _.zOrigin && pn(this, _, 'zOrigin', _.zOrigin, h), pn(this, k, c, kn(s), kn(a)));
                                        continue;
                                    }
                                    if ('svgOrigin' === c) {
                                        En(e, a, 1, y, 0, this);
                            ...
                            if (m || ((o || 0 === o) && (l || 0 === l) && !zi.test(a) && c in k))
                                o || (o = 0), (p = (s + '').substr((l + '').length)) !== (h = Ue(a) || (c in v.units ? v.units[c] : p)) && (l = mn(e, c, s, h)), (this._pt = new li(this._pt, m ? _ : k, c, l, (f ? fe(l, f + o) : o) - l, m || ('px' !== h && 'zIndex' !== c) || !1 === t.autoRound ? Bi : Ni)), (this._pt.u = h || 0), p !== h && '%' !== h && ((this._pt.b = s), (this._pt.r = Ri));
            ...
            getSetter: function (e, t, i) {
                var n = Ii[t];
                return n && n.indexOf(',') < 0 && (t = n), t in Oi && t !== Ki && (e._gsap.x || gn(e, 'x')) ? (i && Ei === i ? ('scale' === t ? Yi : Vi) : (Ei = i || {}) && ('scale' === t ? Xi : Wi)) : e.style && !P(e.style[t]) ? ji : ~t.indexOf('-') ? Hi : Jt(e, t);
            },
            core: { _removeProperty: cn, _getMatrix: Sn },
        };
    (wi.utils.checkPrefix = sn),
        (wi.core.getStyleSaver = en),
        (Nn = ce('x,y,z,scale,scaleX,scaleY,xPercent,yPercent' + ',' + (Rn = 'rotation,rotationX,rotationY,skewX,skewY') + ',transform,transformOrigin,svgOrigin,force3D,smoothOrigin,transformPerspective', function (e) {
            Oi[e] = 1;
        })),
        ce(Rn, function (e) {
    ...
    function jn(e) {
        return (e.innerHTML = e.innerText.replace(/(\S*)/g, (e) => '<div style="display: inline-block" class="word">' + e.replace(/(#|@)?\S(#|@)?/g, "<div style='display: inline-block' class='letter'>$&</div>") + '</div>')), e;
    }
    qn.core.Tween;
    ...
    if (null !== Hn) {
        ...
        n.forEach((t) => {
            ...
            Hn.querySelectorAll('.hero-1c__item').forEach((t, i) => {
                e.fromTo(t.querySelector('.line-horizontal-top'), { width: 0 }, { width: '100%', duration: 0.3 }, '-=' + 0.6 * i);
                let r = t.querySelector('.line-vertical-right');
                null !== r && e.fromTo(r, { height: 0 }, { height: '100%', duration: 0.3 }),
                    e.fromTo(t.querySelector('.hero-1c__icon'), { opacity: 0, y: 5, x: 5 }, { opacity: 1, y: 0, x: 0, duration: 0.3 }, '-=' + 0.4 * i),
                    ...
                    e.fromTo(t.querySelector('.hero-1c__text'), { opacity: 0, y: 5, x: 5 }, { opacity: 1, y: 0, x: 0, duration: 0.3 });
            }),
            e.fromTo(Hn.querySelector('.hero-1c__form'), { opacity: 0, y: 10, x: 10 }, { opacity: 1, y: 0, x: 0, duration: 0.3 });
    }
    function Vn(e) {
    ...
    function ir(e) {
        return function (...t) {
            if (void 0 === t[0]) {
                for (let t = 0; t < this.length; t += 1) tr.indexOf(e) < 0 && (e in this[t] ? this[t][e]() : er(this[t]).trigger(e));
                return this;
            }
            return this.on(e, ...t);
        };
    }
    ir('click'), ir('blur'), ir('focus'), ir('focusin'), ir('focusout'), ir('keyup'), ir('keydown'), ir('keypress'), ir('submit'), ir('change'), ir('mousedown'), ir('mousemove'), ir('mouseup'), ir('mouseenter'), ir('mouseleave'), ir('mouseout'), ir('mouseover'), ir('touchstart'), ir('touchend'), ir('touchmove'), ir('resize'), ir('scroll');
    const nr = {
        addClass: function (...e) {
            ...
            for (let e = 0; e < this.length; e += 1) {
                ...
                if (i)
                    for (l = 0; l < o.length; l += 1) {
                        const e = o[l];
                        t.dom7LiveListeners || (t.dom7LiveListeners = {}), t.dom7LiveListeners[e] || (t.dom7LiveListeners[e] = []), t.dom7LiveListeners[e].push({ listener: n, proxyListener: s }), t.addEventListener(e, s, r);
                    }
                else
                    for (l = 0; l < o.length; l += 1) {
                        const e = o[l];
                        t.dom7Listeners || (t.dom7Listeners = {}), t.dom7Listeners[e] || (t.dom7Listeners[e] = []), t.dom7Listeners[e].push({ listener: n, proxyListener: a }), t.addEventListener(e, a, r);
                    }
            }
            return this;
        },
        ...
        prepend: function (e) {
            ...
            for (i = 0; i < this.length; i += 1)
                ...
                } else if (e instanceof Qn) for (n = 0; n < e.length; n += 1) this[i].insertBefore(e[n], this[i].childNodes[0]);
                else this[i].insertBefore(e, this[i].childNodes[0]);
            return this;
        },
        next: function (e) {
            return this.length > 0 ? (e ? (this[0].nextElementSibling && er(this[0].nextElementSibling).is(e) ? er([this[0].nextElementSibling]) : er([])) : this[0].nextElementSibling ? er([this[0].nextElementSibling]) : er([])) : er([]);
        },
        nextAll: function (e) {
            const t = [];
            let i = this[0];
        ...
        prev: function (e) {
            if (this.length > 0) {
                const t = this[0];
                return e ? (t.previousElementSibling && er(t.previousElementSibling).is(e) ? er([t.previousElementSibling]) : er([])) : t.previousElementSibling ? er([t.previousElementSibling]) : er([]);
            }
            return er([]);
        },
        prevAll: function (e) {
        ...
        parent: function (e) {
            const t = [];
            for (let i = 0; i < this.length; i += 1) null !== this[i].parentNode && (e ? er(this[i].parentNode).is(e) && t.push(this[i].parentNode) : t.push(this[i].parentNode));
            return er(t);
        },
        parents: function (e) {
            const t = [];
        ...
        for (let r = 1; r < e.length; r += 1) {
            ...
            if (null != s && ((n = s), !('undefined' != typeof window && void 0 !== window.HTMLElement ? n instanceof HTMLElement : n && (1 === n.nodeType || 11 === n.nodeType)))) {
                ...
                for (let i = 0, n = e.length; i < n; i += 1) {
                    ...
                    void 0 !== r && r.enumerable && (or(t[n]) && or(s[n]) ? (s[n].__swiper__ ? (t[n] = s[n]) : lr(t[n], s[n])) : !or(t[n]) && or(s[n]) ? ((t[n] = {}), s[n].__swiper__ ? (t[n] = s[n]) : lr(t[n], s[n])) : (t[n] = s[n]));
                }
            }
        }
        var n;
        ...
        gr = {
            updateSize: function () {
                ...
                (t = void 0 !== e.params.width && null !== e.params.width ? e.params.width : n[0].clientWidth),
                    ...
                    (0 === t && e.isHorizontal()) ||
                        (0 === i && e.isVertical()) ||
                        ((t = t - parseInt(n.css('padding-left') || 0, 10) - parseInt(n.css('padding-right') || 0, 10)), (i = i - parseInt(n.css('padding-top') || 0, 10) - parseInt(n.css('padding-bottom') || 0, 10)), Number.isNaN(t) && (t = 0), Number.isNaN(i) && (i = 0), Object.assign(e, { width: t, height: i, size: e.isHorizontal() ? t : i }));
            },
            updateSlides: function () {
                ...
                'string' == typeof y && y.indexOf('%') >= 0 && (y = (parseFloat(y.replace('%', '')) / 100) * s),
                    ...
                    n.centeredSlides && n.cssMode && (dr(e.wrapperEl, '--swiper-centered-offset-before', ''), dr(e.wrapperEl, '--swiper-centered-offset-after', ''));
                ...
                for (let r = 0; r < c; r += 1) {
                    ...
                    if ((x && e.grid.updateSlide(r, a, c, t), 'none' !== a.css('display'))) {
                        ...
                        } else (C = (s - (n.slidesPerView - 1) * y) / n.slidesPerView), n.roundLengths && (C = Math.floor(C)), u[r] && (u[r].style[t('width')] = `${C}px`);
                        u[r] && (u[r].swiperSlideSize = C),
                            f.push(C),
                            n.centeredSlides
                                ? ((w = w + C / 2 + b / 2 + y), 0 === b && 0 !== r && (w = w - s / 2 - y), 0 === r && (w = w - s / 2 - y), Math.abs(w) < 0.001 && (w = 0), n.roundLengths && (w = Math.floor(w)), T % n.slidesPerGroup == 0 && p.push(w), h.push(w))
                                : (n.roundLengths && (w = Math.floor(w)), (T - Math.min(e.params.slidesPerGroupSkip, T)) % e.params.slidesPerGroup == 0 && p.push(w), h.push(w), (w = w + C + y)),
                            (e.virtualSize += C + y),
                            (b = C),
                            (T += 1);
                    }
                }
                if (((e.virtualSize = Math.max(e.virtualSize, s) + g), a && o && ('slide' === n.effect || 'coverflow' === n.effect) && r.css({ width: `${e.virtualSize + n.spaceBetween}px` }), n.setWrapperSize && r.css({ [t('width')]: `${e.virtualSize + n.spaceBetween}px` }), x && e.grid.updateWrapperSize(C, p, t), !n.centeredSlides)) {
                    const t = [];
                ...
                if ((Object.assign(e, { slides: u, snapGrid: p, slidesGrid: h, slidesSizesGrid: f }), n.centeredSlides && n.cssMode && !n.centeredSlidesBounds)) {
                    dr(e.wrapperEl, '--swiper-centered-offset-before', -p[0] + 'px'), dr(e.wrapperEl, '--swiper-centered-offset-after', e.size / 2 - f[f.length - 1] / 2 + 'px');
                    const t = -e.snapGrid[0],
                        i = -e.slidesGrid[0];
                    (e.snapGrid = e.snapGrid.map((e) => e + t)), (e.slidesGrid = e.slidesGrid.map((e) => e + i));
                }
                c !== d && e.emit('slidesLengthChange'), p.length !== v && (e.params.watchOverflow && e.checkOverflow(), e.emit('snapGridLengthChange')), h.length !== _ && e.emit('slidesGridLengthChange'), n.watchSlidesProgress && e.updateSlidesOffset();
            },
            ...
            updateSlidesProgress: function (e = (this && this.translate) || 0) {
                ...
                for (let e = 0; e < n.length; e += 1) {
                    ...
                    ((c >= 0 && c < t.size - 1) || (p > 1 && p <= t.size) || (c <= 0 && p >= t.size)) && (t.visibleSlides.push(o), t.visibleSlidesIndexes.push(e), n.eq(e).addClass(i.slideVisibleClass)), (o.progress = r ? -d : d), (o.originalProgress = r ? -u : u);
                }
            ...
            updateProgress: function (e) {
                ...
                const o = s,
                    l = a;
                0 === n ? ((r = 0), (s = !0), (a = !0)) : ((r = (e - t.minTranslate()) / n), (s = r <= 0), (a = r >= 1)),
            ...
            updateSlidesClasses: function () {
                ...
                i.loop && 0 === d.length && ((d = t.eq(-1)), d.addClass(i.slidePrevClass)),
                    i.loop &&
                        (l.hasClass(i.slideDuplicateClass) ? n.children(`.${i.slideClass}:not(.${i.slideDuplicateClass})[data-swiper-slide-index="${l.attr('data-swiper-slide-index')}"]`).addClass(i.slideDuplicateNextClass) : n.children(`.${i.slideClass}.${i.slideDuplicateClass}[data-swiper-slide-index="${l.attr('data-swiper-slide-index')}"]`).addClass(i.slideDuplicateNextClass),
            ...
            updateActiveIndex: function (e) {
                ...
                if ((d >= r.length && (d = r.length - 1), u === a)) return void (d !== l && ((t.snapIndex = d), t.emit('snapIndexChange')));
                const c = parseInt(t.slides.eq(u).attr('data-swiper-slide-index') || u, 10);
                Object.assign(t, { snapIndex: d, realIndex: c, previousIndex: a, activeIndex: u }), t.emit('activeIndexChange'), t.emit('snapIndexChange'), o !== c && t.emit('realIndexChange'), (t.initialized || t.params.runCallbacksOnInit) && t.emit('slideChange');
            },
            updateClickedSlide: function (e) {
                ...
                (t.clickedSlide = n), t.virtual && t.params.virtual.enabled ? (t.clickedIndex = parseInt(rr(n).attr('data-swiper-slide-index'), 10)) : (t.clickedIndex = r), i.slideToClickedSlide && void 0 !== t.clickedIndex && t.clickedIndex !== t.activeIndex && t.slideToClickedSlide();
            },
        };
    ...
    const _r = {
            slideTo: function (e = 0, t = this.params.speed, i = !0, n, r) {
                ...
                g >= l.length && (g = l.length - 1), (c || o.initialSlide || 0) === (u || 0) && i && s.emit('beforeSlideChangeStart');
                const v = -l[g];
                if ((s.updateProgress(v), o.normalizeSlideIndex))
                    for (let e = 0; e < d.length; e += 1) {
                        ...
                        void 0 !== d[e + 1] ? (t >= i && t < n - (n - i) / 2 ? (a = e) : t >= i && t < n && (a = e + 1)) : t >= i && (a = e);
                    }
                ...
                let _;
                if (((_ = a > c ? 'next' : a < c ? 'prev' : 'reset'), (p && -v === s.translate) || (!p && v === s.translate))) return s.updateActiveIndex(a), o.autoHeight && s.updateAutoHeight(), s.updateSlidesClasses(), 'slide' !== o.effect && s.setTranslate(v), 'reset' !== _ && (s.transitionStart(i, _), s.transitionEnd(i, _)), !1;
                if (o.cssMode) {
                    ...
                    if (0 === t) {
                        ...
                        if (!s.support.smoothScroll) return ur({ swiper: s, targetPosition: i, side: e ? 'left' : 'top' }), !0;
            ...
            slidePrev: function (e = this.params.speed, t = !0, i) {
                ...
                let f = 0;
                return void 0 !== h && ((f = o.indexOf(h)), f < 0 && (f = n.activeIndex - 1), 'auto' === r.slidesPerView && 1 === r.slidesPerGroup && r.slidesPerGroupAuto && ((f = f - n.slidesPerViewDynamic('previous', !0) + 1), (f = Math.max(f, 0)))), r.rewind && n.isBeginning ? n.slideTo(n.slides.length - 1, e, t, i) : n.slideTo(f, e, t, i);
            },
        ...
        yr = {
            loopCreate: function () {
                ...
                for (let e = a.length - 1; e >= 0; e -= 1) r.prepend(rr(a[e].cloneNode(!0)).addClass(i.slideDuplicateClass));
            },
            loopFix: function () {
                const e = this;
                e.emit('beforeLoopFix');
                const { activeIndex: t, slides: i, loopedSlides: n, allowSlidePrev: r, allowSlideNext: s, snapGrid: a, rtlTranslate: o } = e;
                let l;
                (e.allowSlidePrev = !0), (e.allowSlideNext = !0);
                const d = -a[t] - e.getTranslate();
                t < n ? ((l = i.length - 3 * n + t), (l += n), e.slideTo(l, 0, !1, !0) && 0 !== d && e.setTranslate((o ? -e.translate : e.translate) - d)) : t >= i.length - n && ((l = -i.length + t + n), (l += n), e.slideTo(l, 0, !1, !0) && 0 !== d && e.setTranslate((o ? -e.translate : e.translate) - d)), (e.allowSlidePrev = r), (e.allowSlideNext = s), e.emit('loopFix');
            },
    ...
    function wr(e) {
        ...
        s.noSwipingClass && '' !== s.noSwipingClass && l.target && l.target.shadowRoot && e.path && e.path[0] && (d = rr(e.path[0]));
        ...
        if (
            ...
            (c
                ? (function (e, t = this) {
                      return (function t(i) {
                          return i && i !== Wn() && i !== Kn() ? (i.assignedSlot && (i = i.assignedSlot), i.closest(e) || t(i.getRootNode().host)) : null;
                      })(t);
                  })(u, l.target)
                : d.closest(u)[0])
        )
        ...
        if ((Object.assign(r, { isTouched: !0, isMoved: !1, allowTouchCallbacks: !0, isScrolling: void 0, startMoving: void 0 }), (a.startX = p), (a.startY = h), (r.touchStartTime = ar()), (t.allowClick = !0), t.updateSize(), (t.swipeDirection = void 0), s.threshold > 0 && (r.allowThresholdMove = !1), 'touchstart' !== l.type)) {
            let e = !0;
            d.is(r.focusableElements) && (e = !1), i.activeElement && rr(i.activeElement).is(r.focusableElements) && i.activeElement !== d[0] && i.activeElement.blur();
    ...
    function br(e) {
        ...
        if (!i.allowTouchMove) return (i.allowClick = !1), void (n.isTouched && (Object.assign(s, { startX: u, startY: c, currentX: u, currentY: c }), (n.touchStartTime = ar())));
        ...
        if (n.isTouchEvent && t.activeElement && l.target === t.activeElement && rr(l.target).is(n.focusableElements)) return (n.isMoved = !0), void (i.allowClick = !1);
        ...
        if (void 0 === n.isScrolling) {
            let e;
            (i.isHorizontal() && s.currentY === s.startY) || (i.isVertical() && s.currentX === s.startX) ? (n.isScrolling = !1) : p * p + h * h >= 25 && ((e = (180 * Math.atan2(Math.abs(h), Math.abs(p))) / Math.PI), (n.isScrolling = i.isHorizontal() ? e > r.touchAngle : 90 - e > r.touchAngle));
        }
        ...
        (i.allowClick = !1),
            ...
            n.isMoved || (r.loop && !r.cssMode && i.loopFix(), (n.startTranslate = i.getTranslate()), i.setTransition(0), i.animating && i.$wrapperEl.trigger('webkitTransitionEnd transitionend'), (n.allowMomentumBounce = !1), !r.grabCursor || (!0 !== i.allowSlideNext && !0 !== i.allowSlidePrev) || i.setGrabCursor(!0), i.emit('sliderFirstMove', l)),
            i.emit('sliderMove', l),
            (n.isMoved = !0);
        ...
        if (
            ...
            f > 0 && n.currentTranslate > i.minTranslate() ? ((m = !1), r.resistance && (n.currentTranslate = i.minTranslate() - 1 + (-i.minTranslate() + n.startTranslate + f) ** g)) : f < 0 && n.currentTranslate < i.maxTranslate() && ((m = !1), r.resistance && (n.currentTranslate = i.maxTranslate() + 1 - (i.maxTranslate() - n.startTranslate - f) ** g)),
    ...
    function Tr(e) {
        ...
        if (t.allowClick) {
            ...
            t.updateClickedSlide((e && e[0]) || l.target), t.emit('tap click', l), u < 300 && d - i.lastClickTime < 300 && t.emit('doubleTap doubleClick', l);
        }
        if (
            ((i.lastClickTime = ar()),
            sr(() => {
        ...
        let c;
        if (((i.isTouched = !1), (i.isMoved = !1), (i.startMoving = !1), (c = n.followFinger ? (s ? t.translate : -t.translate) : -i.currentTranslate), n.cssMode)) return;
        ...
        for (let e = 0; e < a.length; e += e < n.slidesPerGroupSkip ? 1 : n.slidesPerGroup) {
            ...
            void 0 !== a[e + t] ? c >= a[e] && c < a[e + t] && ((p = e), (h = a[e + t] - a[e])) : c >= a[e] && ((p = e), (h = a[a.length - 1] - a[a.length - 2]));
        }
        const f = (c - a[p]) / h,
    ...
    const kr = (e, t) => {
            ...
            if (l.touch) {
                ...
                s[u](r.start, e.onTouchStart, t), s[u](r.move, e.onTouchMove, l.passiveListener ? { passive: !1, capture: d } : d), s[u](r.end, e.onTouchEnd, t), r.cancel && s[u](r.cancel, e.onTouchEnd, t);
            } else s[u](r.start, e.onTouchStart, !1), i[u](r.move, e.onTouchMove, d), i[u](r.end, e.onTouchEnd, !1);
            (n.preventClicks || n.preventClicksPropagation) && s[u]('click', e.onClick, !0), n.cssMode && a[u]('scroll', e.onScroll), n.updateOnWindowResize ? e[c](o.ios || o.android ? 'resize orientationchange observerUpdate' : 'resize observerUpdate', xr, !0) : e[c]('observerUpdate', xr, !0);
        },
        Or = {
            attachEvents: function () {
                ...
                (e.onTouchStart = wr.bind(e)), (e.onTouchMove = br.bind(e)), (e.onTouchEnd = Tr.bind(e)), i.cssMode && (e.onScroll = Sr.bind(e)), (e.onClick = Cr.bind(e)), n.touch && !Er && (t.addEventListener('touchstart', Mr), (Er = !0)), kr(e, 'on');
            },
    ...
    function $r(e, t) {
        return function (i = {}) {
            const n = Object.keys(i)[0],
                r = i[n];
            'object' == typeof r && null !== r ? (['navigation', 'pagination', 'scrollbar'].indexOf(n) >= 0 && !0 === e[n] && (e[n] = { auto: !0 }), n in e && 'enabled' in r ? (!0 === e[n] && (e[n] = { enabled: !0 }), 'object' != typeof e[n] || 'enabled' in e[n] || (e[n].enabled = !0), e[n] || (e[n] = { enabled: !1 }), lr(t, i)) : lr(t, i)) : lr(t, i);
        };
    }
    const Dr = {
            eventsEmitter: mr,
            ...
            translate: {
                ...
                setTranslate: function (e, t) {
                    ...
                    let l,
                        d = 0,
                        u = 0;
                    i.isHorizontal() ? (d = n ? -e : e) : (u = e), r.roundLengths && ((d = Math.floor(d)), (u = Math.floor(u))), r.cssMode ? (a[i.isHorizontal() ? 'scrollLeft' : 'scrollTop'] = i.isHorizontal() ? -d : -u) : r.virtualTranslate || s.transform(`translate3d(${d}px, ${u}px, 0px)`), (i.previousTranslate = i.translate), (i.translate = i.isHorizontal() ? d : u);
                ...
                translateTo: function (e = 0, t = this.params.speed, i = !0, n = !0, r) {
                    ...
                    if (((u = n && e > l ? l : n && e < d ? d : e), s.updateProgress(u), a.cssMode)) {
                        ...
                        if (0 === t) o[e ? 'scrollLeft' : 'scrollTop'] = -u;
                            ...
                            if (!s.support.smoothScroll) return ur({ swiper: s, targetPosition: -u, side: e ? 'left' : 'top' }), !0;
                    ...
                    return (
                        0 === t
                            ? (s.setTransition(0), s.setTranslate(u), i && (s.emit('beforeTransitionStart', t, r), s.emit('transitionEnd')))
                            : (s.setTransition(t),
                              s.setTranslate(u),
            ...
            transition: {
                ...
                transitionStart: function (e = !0, t) {
                    const i = this,
                        { params: n } = i;
                    n.cssMode || (n.autoHeight && i.updateAutoHeight(), vr({ swiper: i, runCallbacks: e, direction: t, step: 'Start' }));
                },
                transitionEnd: function (e = !0, t) {
                    const i = this,
                        { params: n } = i;
                    (i.animating = !1), n.cssMode || (i.setTransition(0), vr({ swiper: i, runCallbacks: e, direction: t, step: 'End' }));
                },
            },
            slide: _r,
            loop: yr,
            ...
            breakpoints: {
                setBreakpoint: function () {
                    ...
                    const l = (o in a ? a[o] : void 0) || e.originalParams,
                        ...
                        u = Pr(e, l),
                        c = r.enabled;
                    d && !u ? (s.removeClass(`${r.containerModifierClass}grid ${r.containerModifierClass}grid-column`), e.emitContainerClasses()) : !d && u && (s.addClass(`${r.containerModifierClass}grid`), ((l.grid.fill && 'column' === l.grid.fill) || (!l.grid.fill && 'column' === r.grid.fill)) && s.addClass(`${r.containerModifierClass}grid-column`), e.emitContainerClasses());
            ...
            images: {
                loadImage: function (e, t, i, n, r, s) {
                    ...
                    rr(e).parent('picture')[0] || (e.complete && r) ? l() : t ? ((o = new a.Image()), (o.onload = l), (o.onerror = l), n && (o.sizes = n), i && (o.srcset = i), t && (o.src = t)) : l();
                },
    ...
    class Ir {
        constructor(...e) {
            let t, i;
            if ((1 === e.length && e[0].constructor && 'Object' === Object.prototype.toString.call(e[0]).slice(8, -1) ? (i = e[0]) : ([t, i] = e), i || (i = {}), (i = lr({}, i)), t && !i.el && (i.el = t), i.el && rr(i.el).length > 1)) {
                const e = [];
                return (
                    rr(i.el).each((t) => {
                        const n = lr({}, i, { el: t });
                    ...
                    return (
                        pr ||
                            (pr = (function ({ userAgent: e } = {}) {
                                ...
                                let h = 'MacIntel' === n;
                                return (
                                    !d && h && t.touch && ['1024x1366', '1366x1024', '834x1194', '1194x834', '834x1112', '1112x834', '768x1024', '1024x768', '820x1180', '1180x820', '810x1080', '1080x810'].indexOf(`${a}x${o}`) >= 0 && ((d = r.match(/(Version)\/([\d.]+)/)), d || (d = [0, 1, '13_0_0']), (h = !1)),
            ...
            const r = {};
            n.modules.forEach((e) => {
                e({ swiper: n, extendParams: $r(i, r), on: n.on.bind(n), once: n.once.bind(n), off: n.off.bind(n), emit: n.emit.bind(n) });
            });
            const s = lr({}, Lr, r);
            return (
                (n.params = lr({}, s, zr, i)),
                ...
                Object.assign(n, {
                    ...
                    touchEvents: (function () {
                        ...
                        return (n.touchEventsTouch = { start: e[0], move: e[1], end: e[2], cancel: e[3] }), (n.touchEventsDesktop = { start: t[0], move: t[1], end: t[2] }), n.support.touch || !n.params.simulateTouch ? n.touchEventsTouch : n.touchEventsDesktop;
                    })(),
                    touchEventsData: {
                        isTouched: void 0,
                        isMoved: void 0,
        ...
        update() {
            ...
            i.breakpoints && e.setBreakpoint(),
                ...
                e.updateProgress(),
                e.updateSlidesClasses(),
                e.params.freeMode && e.params.freeMode.enabled ? (n(), e.params.autoHeight && e.updateAutoHeight()) : ((r = ('auto' === e.params.slidesPerView || e.params.slidesPerView > 1) && e.isEnd && !e.params.centeredSlides ? e.slideTo(e.slides.length - 1, 0, !1, !0) : e.slideTo(e.activeIndex, 0, !1, !0)), r || n()),
        ...
        Ir.use([
            function ({ swiper: e, on: t, emit: i }) {
                ...
                t('init', () => {
                        ...
                        ? e &&
                          ...
                          ((r = new ResizeObserver((t) => {
                              ...
                              t.forEach(({ contentBoxSize: t, contentRect: i, target: n }) => {
                                  (n && n !== e.el) || ((r = i ? i.width : (t[0] || t).inlineSize), (a = i ? i.height : (t[0] || t).blockSize));
                              }),
                                  (r === i && a === n) || s();
                          })),
                          r.observe(e.el))
                    ...
                    t('destroy', () => {
                        r && r.unobserve && e.el && (r.unobserve(e.el), (r = null)), n.removeEventListener('resize', s), n.removeEventListener('orientationchange', a);
                    });
            },
    ...
    Br.use([
        function ({ swiper: e, extendParams: t, on: i, emit: n }) {
            function r(t) {
                let i;
                return t && ((i = rr(t)), e.params.uniqueNavElements && 'string' == typeof t && i.length > 1 && 1 === e.$el.find(t).length && (i = e.$el.find(t))), i;
            }
            function s(t, i) {
            ...
            function d() {
                ...
                if (((e.params.navigation = Fr(e, e.originalParams.navigation, e.params.navigation, { nextEl: 'swiper-button-next', prevEl: 'swiper-button-prev' })), !t.nextEl && !t.prevEl)) return;
                const i = r(t.nextEl),
                    n = r(t.prevEl);
                i && i.length > 0 && i.on('click', l), n && n.length > 0 && n.on('click', o), Object.assign(e.navigation, { $nextEl: i, nextEl: i && i[0], $prevEl: n, prevEl: n && n[0] }), e.enabled || (i && i.addClass(t.lockClass), n && n.addClass(t.lockClass));
            }
            function u() {
                const { $nextEl: t, $prevEl: i } = e.navigation;
            ...
            t({ navigation: { nextEl: null, prevEl: null, hideOnClick: !1, disabledClass: 'swiper-button-disabled', hiddenClass: 'swiper-button-hidden', lockClass: 'swiper-button-lock' } }),
                ...
                i('click', (t, i) => {
                    ...
                    if (e.params.navigation.hideOnClick && !rr(a).is(s) && !rr(a).is(r)) {
                        ...
                        let t;
                        r ? (t = r.hasClass(e.params.navigation.hiddenClass)) : s && (t = s.hasClass(e.params.navigation.hiddenClass)), n(!0 === t ? 'navigationShow' : 'navigationHide'), r && r.toggleClass(e.params.navigation.hiddenClass), s && s.toggleClass(e.params.navigation.hiddenClass);
                    }
                }),
        ...
        function ({ swiper: e, extendParams: t, on: i, emit: n }) {
            ...
            function d() {
                ...
                if (
                    (e.params.loop ? ((u = Math.ceil((e.activeIndex - e.loopedSlides) / e.params.slidesPerGroup)), u > r - 1 - 2 * e.loopedSlides && (u -= r - 2 * e.loopedSlides), u > c - 1 && (u -= c), u < 0 && 'bullets' !== e.params.paginationType && (u = c + u)) : (u = void 0 !== e.snapIndex ? e.snapIndex : e.activeIndex || 0),
                    ...
                    if (
                        (i.dynamicBullets &&
                            ...
                            i.dynamicMainBullets > 1 && void 0 !== e.previousIndex && ((a += u - (e.previousIndex - e.loopedSlides || 0)), a > i.dynamicMainBullets - 1 ? (a = i.dynamicMainBullets - 1) : a < 0 && (a = 0)),
                            (r = Math.max(u - a, 0)),
                        ...
                        n.each((e) => {
                            const t = rr(e),
                                n = t.index();
                            n === u && t.addClass(i.bulletActiveClass), i.dynamicBullets && (n >= r && n <= o && t.addClass(`${i.bulletActiveClass}-main`), n === r && l(t, 'prev'), n === o && l(t, 'next'));
                        });
                    else {
                        const t = n.eq(u),
                            s = t.index();
                ...
                if (('fraction' === i.type && (d.find(Rr(i.currentClass)).text(i.formatFractionCurrent(u + 1)), d.find(Rr(i.totalClass)).text(i.formatFractionTotal(c))), 'progressbar' === i.type)) {
                    let t;
                    t = i.progressbarOpposite ? (e.isHorizontal() ? 'vertical' : 'horizontal') : e.isHorizontal() ? 'horizontal' : 'vertical';
                    const n = (u + 1) / c;
                    let r = 1,
                        s = 1;
                    'horizontal' === t ? (r = n) : (s = n), d.find(Rr(i.progressbarFillClass)).transform(`translate3d(0,0,0) scaleX(${r}) scaleY(${s})`).transition(e.params.speed);
                }
                'custom' === i.type && i.renderCustom ? (d.html(i.renderCustom(e, u + 1, c)), n('paginationRender', d[0])) : n('paginationUpdate', d[0]), e.params.watchOverflow && e.enabled && d[e.isLocked ? 'addClass' : 'removeClass'](i.lockClass);
            }
            function u() {
                ...
                if ('bullets' === t.type) {
                    ...
                    for (let i = 0; i < n; i += 1) t.renderBullet ? (s += t.renderBullet.call(e, i, t.bulletClass)) : (s += `<${t.bulletElement} class="${t.bulletClass}"></${t.bulletElement}>`);
                    r.html(s), (e.pagination.bullets = r.find(Rr(t.bulletClass)));
                }
                'fraction' === t.type && ((s = t.renderFraction ? t.renderFraction.call(e, t.currentClass, t.totalClass) : `<span class="${t.currentClass}"></span> / <span class="${t.totalClass}"></span>`), r.html(s)),
                    'progressbar' === t.type && ((s = t.renderProgressbar ? t.renderProgressbar.call(e, t.progressbarFillClass) : `<span class="${t.progressbarFillClass}"></span>`), r.html(s)),
                    'custom' !== t.type && n('paginationRender', e.pagination.$el[0]);
            }
            function c() {
                e.params.pagination = Fr(e, e.originalParams.pagination, e.params.pagination, { el: 'swiper-pagination' });
                const t = e.params.pagination;
                if (!t.el) return;
                let i = rr(t.el);
                0 !== i.length &&
                    (e.params.uniqueNavElements && 'string' == typeof t.el && i.length > 1 && ((i = e.$el.find(t.el)), i.length > 1 && (i = i.filter((t) => rr(t).parents('.swiper')[0] === e.el))),
            ...
            function p() {
                ...
                i.removeClass(t.hiddenClass), i.removeClass(t.modifierClass + t.type), i.removeClass(t.modifierClass + e.params.direction), e.pagination.bullets && e.pagination.bullets.removeClass && e.pagination.bullets.removeClass(t.bulletActiveClass), t.clickable && i.off('click', Rr(t.bulletClass));
            }
            i('init', () => {
                c(), u(), d();
            }),
                ...
                i('click', (t, i) => {
                    const r = i.target,
                        { $el: s } = e.pagination;
                    if (e.params.pagination.el && e.params.pagination.hideOnClick && s.length > 0 && !rr(r).hasClass(e.params.pagination.bulletClass)) {
        ...
        function ({ swiper: e, extendParams: t, on: i, emit: n }) {
            ...
            (e.autoplay = { running: !1, paused: !1 }),
                ...
                i('init', () => {
                    e.params.autoplay.enabled && (a(), Wn().addEventListener('visibilitychange', d), e.params.autoplay.pauseOnMouseEnter && (e.$el.on('mouseenter', c), e.$el.on('mouseleave', p)));
                }),
                ...
                i('destroy', () => {
                    e.$el.off('mouseenter', c), e.$el.off('mouseleave', p), e.autoplay.running && o(), Wn().removeEventListener('visibilitychange', d);
                }),
        ...
        function ({ swiper: e, extendParams: t, on: i, emit: n }) {
            ...
            function c(t) {
                return !(
                    ...
                    (!(t.delta >= 6 && ar() - o < 60) && (t.direction < 0 ? (e.isEnd && !e.params.loop) || e.animating || (e.slideNext(), n('scroll', t.raw)) : (e.isBeginning && !e.params.loop) || e.animating || (e.slidePrev(), n('scroll', t.raw)), (o = new r.Date().getTime()), 1))
                );
            }
            function p(t) {
                let i = t,
                ...
                let d = e.$el;
                if (('container' !== e.params.mousewheel.eventsTarget && (d = rr(e.params.mousewheel.eventsTarget)), !e.mouseEntered && !d[0].contains(i.target) && !o.releaseOnEdges)) return !0;
                ...
                if ((f >= e.minTranslate() && (f = e.minTranslate()), f <= e.maxTranslate() && (f = e.maxTranslate()), (r = !!e.params.loop || !(f === e.minTranslate() || f === e.maxTranslate())), r && e.params.nested && i.stopPropagation(), e.params.freeMode && e.params.freeMode.enabled)) {
                    ...
                    if (!r) {
                        ...
                        if ((r || n('scroll', i), e.params.autoplay && e.params.autoplayDisableOnInteraction && e.autoplay.stop(), d === e.minTranslate() || d === e.maxTranslate())) return !0;
                    }
                } else {
            ...
            function h(t) {
                let i = e.$el;
                'container' !== e.params.mousewheel.eventsTarget && (i = rr(e.params.mousewheel.eventsTarget)), i[t]('mouseenter', d), i[t]('mouseleave', u), i[t]('wheel', p);
            }
            function f() {
    ...
    jr.setAttribute('data-max-slides', qr.querySelectorAll('.swiper-slide').length), new Br('.contacts-1c__slider', { slidesPerView: 1, speed: 400, navigation: { nextEl: '.contacts-1c__button-next', prevEl: '.contacts-1c__button-prev' }, pagination: { el: jr, type: 'progressbar' }, loop: !0 });
    let Hr = 0,
        Vr = 0;
    const Yr = new Br('.main-1c', {
            ...
            direction: 'vertical',
            mousewheel: !0,
            navigation: { nextEl: '.main-1c__button-next', prevEl: '.main-1c__button-prev', disabledClass: 'main-1c__button-disabled' },
            on: {
                activeIndexChange: () => {
                    if (1 == Yr.activeIndex) {
                        if (0 == Vr && null !== Gr) {
                            ...
                            (i = Array.from(Nr(n).querySelectorAll('.letter'))),
                                ...
                                Gr.querySelectorAll('.client-1c__item').forEach((t, n) => {
                                    e.fromTo(t.querySelector('.line-horizontal-top'), { width: 0 }, { width: '100%', duration: 0.3 }, '-=' + 0.6 * n);
                                    let r = t.querySelector('.line-vertical-right');
                                    null !== r && e.fromTo(r, { height: 0 }, { height: '100%', duration: 0.3 }),
                                        e.fromTo(t.querySelector('.client-1c__container-image'), { opacity: 0, y: 5, x: 5 }, { opacity: 1, y: 0, x: 0, duration: 0.3 }, '-=' + 0.4 * n),
                                        (i = Array.from(Nr(t.querySelector('.client-1c__text')).querySelectorAll('.letter'))),
                                        i.forEach((t) => {
                        ...
                        i.forEach((t) => {
                            ...
                            e.fromTo('.swiper-slide-active .contacts-1c__name', { opacity: 0, y: 5, x: 5 }, { opacity: 1, y: 0, x: 0, duration: 0.5 }, '-=0.2'),
                            e.fromTo('.swiper-slide-active .contacts-1c__job', { opacity: 0, y: 5, x: -5 }, { opacity: 1, y: 0, x: 0, duration: 0.3 }, '-=0.1'),
                            e.fromTo('.swiper-slide-active .contacts-1c__tel', { opacity: 0, y: 5, x: 5 }, { opacity: 1, y: 0, x: 0, duration: 0.3 }, '-=0.1'),
                            e.fromTo('.swiper-slide-active .contacts-1c__descr', { opacity: 0 }, { opacity: 1, y: 0, x: 0, duration: 0.5 });
                        ...
                        (i = Array.from(Nr(n).querySelectorAll('.letter'))),
                            ...
                            e.fromTo('.contacts-1c__container-pagination', { opacity: 0 }, { opacity: 1, duration: 0.5 }),
                            e.fromTo('.contacts-1c__button-faq', { opacity: 0, x: 40 }, { opacity: 1, x: 0, duration: 0.5 });
                    }
                },
            },
        }),
        ...
        Ur = qn.timeline();
    Ur.pause(),
        Ur.to('.popup-1c', { opacity: 1, visibility: 'visible', duration: 0.2 }).fromTo('.popup-1c__form', { opacity: 0, y: -50, visibility: 'hidden' }, { opacity: 1, y: 0, visibility: 'visible', duration: 0.4 }),
